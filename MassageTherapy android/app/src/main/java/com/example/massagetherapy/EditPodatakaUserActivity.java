...
public class EditPodatakaUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_podataka_user);
        ...
        String Ime=sharedPref.getString("Ime","Nema imena");
